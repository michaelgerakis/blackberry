...
mod tests {
    ...
    fn create_read() {
        ...
        use super::{ReadVolatile, Readable};
        let t = unsafe { ReadVolatile::new(&x) };
    ...
    fn create_write() {
        ...
        use super::{WriteVolatile, Writeable};
        let mut t = unsafe { WriteVolatile::new(&mut x) };
    ...
    fn create_read_write() {
        ...
        use super::{Readable, ReadableWriteable, Volatile};

        let mut t = Volatile(&mut x);
